...
=========================================
- 'README.txt'
- 'features_info.txt' with information about the variables.
- 'features.txt' which lists all features.
- 'activity_labels.txt' which lists the class labels with their activity name.
- 'train/X_train.txt' contains training set.
- 'train/y_train.txt' contains training labels.
- 'test/X_test.txt' contains test set.
- 'test/y_test.txt' contains est labels.
